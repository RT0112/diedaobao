...
class FallDetectionService : Service() {
    ...
    private var assistListenerRegistered = false
    ...
    private fun startRemoteAssistPolling() {
        ...
        // 防止重复注册监听器
        if (assistListenerRegistered) {
            Log.w(TAG, "startRemoteAssistPolling: 已注册，跳过")
            return
        }
        assistListenerRegistered = true
    ...
    private fun stopRemoteAssistPolling() {
        assistListenerRegistered = false
